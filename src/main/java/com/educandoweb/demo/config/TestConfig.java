...
@Configuration
@Profile("test")
//CommandLineRunner -> tudo que colocar dentro do método vai ser executado quando a aplicação for iniciada
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category c1 = new Category(null, "Mortgage");
